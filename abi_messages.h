...
/* Version v5.14.0_stable-12-gbf6642b09 */
/* Please DO NOT EDIT */
...
typedef void (*abi_callbackORANGE_COLOR_COLUMNS)(uint8_t sender_id, uint32_t column_1, uint32_t column_2, uint32_t column_3, uint32_t column_4, uint32_t column_5);
...
static inline void AbiSendMsgORANGE_COLOR_COLUMNS(uint8_t sender_id, uint32_t column_1, uint32_t column_2, uint32_t column_3, uint32_t column_4, uint32_t column_5) {
  abi_event* e;
  ABI_FOREACH(abi_queues[ABI_ORANGE_COLOR_COLUMNS_ID],e) {
    if (e->id == ABI_BROADCAST || e->id == sender_id) {
      ...
      cb(sender_id, column_1, column_2, column_3, column_4, column_5);
    }
  }
}
