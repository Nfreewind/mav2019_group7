/* Automatically generated by gen_abi from /home/janjaap/paparazzi/conf/abi.xml */
/* Version v5.14.0_stable-17-gb515f34de */
/* Please DO NOT EDIT */
...
typedef void (*abi_callbackORANGE_COLOR_COLUMNS)(uint8_t sender_id, uint32_t column_1, uint32_t column_2, uint32_t column_3, uint32_t column_4, uint32_t column_5, uint32_t floor_column_1, uint32_t floor_column_2, uint32_t floor_column_3, uint32_t floor_column_4, uint32_t floor_column_5);
...
static inline void AbiSendMsgORANGE_COLOR_COLUMNS(uint8_t sender_id, uint32_t column_1, uint32_t column_2, uint32_t column_3, uint32_t column_4, uint32_t column_5, uint32_t floor_column_1, uint32_t floor_column_2, uint32_t floor_column_3, uint32_t floor_column_4, uint32_t floor_column_5) {
  abi_event* e;
  ABI_FOREACH(abi_queues[ABI_ORANGE_COLOR_COLUMNS_ID],e) {
    if (e->id == ABI_BROADCAST || e->id == sender_id) {
      ...
      cb(sender_id, column_1, column_2, column_3, column_4, column_5, floor_column_1, floor_column_2, floor_column_3, floor_column_4, floor_column_5);
    }
  }
}
